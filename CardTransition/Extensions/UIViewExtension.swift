...
extension UIView {
  ...
  func applyShadow(blur: CGFloat, opacity: Float, color: UIColor, x: CGFloat, y: CGFloat) {
    applyShadow(shadowRadius: blur, shadowOpacity: opacity, shadowColor: color, shadowOffset: CGSize(width: x, height: y))
  }
  ...
  @discardableResult
  func anchor(to view: UIView?) -> Self {
  ...
  @discardableResult
  func anchor(to view: UIView?, below: UIView) -> Self {
  ...
  @discardableResult
  func anchor(to view: UIView?, above: UIView) -> Self {
  ...
  /// Make a view center vertically to superview.
  ///
  /// Only works if the view has a superview
  func centerVerticallyToSuperView() {
    if let superview = self.superview {
      self.center.y = superview.bounds.midY
    }
  }
...
extension UIView {
  ...
  @discardableResult
  func change(backgroundColor: UIColor) -> Self {
